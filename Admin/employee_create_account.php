...
<body>
<form onSubmit="return validate();"  method="POST" action="employee_create_account_check.php"> 
  ...
  <button class="loginbtn1"><a href="dashboard.php" style="text-decoration:none" class="text-white">Back</a></button>
